...
{{
var G__10781 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10781;
continue;
}
} else
...
{var pred__10785 = cljs.core._EQ_;var expr__10786 = limit;if(cljs.core.truth_(pred__10785.call(null,1,expr__10786)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10785.call(null,2,expr__10786)))
...
var G__10788 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10789 = (limit__$1 - 1);
var G__10790 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10788;
limit__$1 = G__10789;
parts = G__10790;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10792 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10792))
{var replacement_10793 = temp__4090__auto___10792;buffer.append([cljs.core.str(replacement_10793)].join(''));
} else
{buffer.append(ch);
}
{
var G__10794 = (index + 1);
index = G__10794;
continue;
}
}
