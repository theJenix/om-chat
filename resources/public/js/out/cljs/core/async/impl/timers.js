...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13728 = 0;while(true){
if((i_13728 < arr.length))
{(arr[i_13728] = null);
{
...
{var i_13735 = (self__.level + 1);while(true){
if((i_13735 <= (new_level + 1)))
{(update[i_13735] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13737 = 0;while(true){
if((i_13737 <= self__.level))
{var links_13738 = (update[i_13737]).forward;if(((links_13738[i_13737]) === x__$1))
{(links_13738[i_13737] = (x__$1.forward[i_13737]));
{
var G__13739 = (i_13737 + 1);
i_13737 = G__13739;
continue;
}
} else
{{
var G__13740 = (i_13737 + 1);
i_13737 = G__13740;
continue;
}
}
