...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13763 = 0;while(true){
var m_13764 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13764 == null))
{} else
{m_13764.call(null);
if((count_13763 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13765 = (count_13763 + 1);
count_13763 = G__13765;
continue;
}
} else
{}
