...
{{
var G__13830 = (i + 1);
var G__13831 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__13830;
acc = G__13831;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t13835 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t13835 = (function (expr,base,xpath,meta13836){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t13835.cljs$lang$type = true;
domina.xpath.t13835.cljs$lang$ctorStr = "domina.xpath/t13835";
domina.xpath.t13835.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"domina.xpath/t13835");
});
domina.xpath.t13835.prototype.domina$DomContent$ = true;
domina.xpath.t13835.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t13835.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t13835.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13837){var self__ = this;
var _13837__$1 = this;return self__.meta13836;
});
domina.xpath.t13835.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13837,meta13836__$1){var self__ = this;
var _13837__$1 = this;return (new domina.xpath.t13835(self__.expr,self__.base,self__.xpath,meta13836__$1));
});
domina.xpath.__GT_t13835 = (function __GT_t13835(expr__$1,base__$1,xpath__$1,meta13836){return (new domina.xpath.t13835(expr__$1,base__$1,xpath__$1,meta13836));
});
}
return (new domina.xpath.t13835(expr,base,xpath,null));
});
